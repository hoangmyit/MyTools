      ...
      <Navbar className="main-header side-header sticky nav nav-item" style={{ marginBottom: '-63px' }}>
        <div className="main-container container-fluid">
          <div className="main-header-left ">
            ...
            <div className="app-sidebar__toggle" data-bs-toggle="sidebar" onClick={() => openCloseSidebar()}>
            ...
            <div className="main-header-center ms-4 d-sm-none d-md-none d-lg-block form-group">
              <Form.Control autoComplete="off" className="form-control" placeholder="Search..." type="search" />
          ...
          <div className="main-header-right">
                ...
                <ul className="nav nav-item header-icons navbar-nav-right pe-0">
                  <li className="dropdown nav-item">
                    <>
                      ...
                      <Modal show={Lang} onHide={() => setLang(false)} centered id="country-selector">
                        <Modal.Header>
                          <h6 className="modal-title">Choose Country</h6>
                          <Button variant="" type="button" onClick={() => setLang(false)}>
                          ...
                          <Row as="ul" className=" p-3">
                            <Col lg={6} as="li" className="mb-2">
                              <Link to="#" className="btn btn-country btn-lg btn-block active">
                                <span className="country-selector">
                                  <img alt="" src={imagesData('us')} className="me-3 language" />
                                </span>
                                Usa{' '}
                              </Link>{' '}
                            </Col>{' '}
                            <Col lg={6} as="li" className="mb-2 mb-2">
                              ...
                              <Link to="#" className="btn btn-country btn-lg btn-block">
                                {' '}
                                <span className="country-selector">
                                  <img alt="" src={imagesData('italy')} className="me-3 language" />
                                </span>
                                Italy{' '}
                              </Link>{' '}
                            </Col>{' '}
                            <Col lg={6} as="li" className="mb-2">
                              ...
                              <Link to="#" className="btn btn-country btn-lg btn-block">
                                {' '}
                                <span className="country-selector">
                                  <img alt="" src={imagesData('spain')} className="me-3 language" />
                                </span>
                                Spain{' '}
                              </Link>{' '}
                            </Col>{' '}
                            <Col lg={6} as="li" className="mb-2">
                              ...
                              <Link to="#" className="btn btn-country btn-lg btn-block">
                                {' '}
                                <span className="country-selector">
                                  <img alt="" src={imagesData('india')} className="me-3 language" />
                                </span>
                                India{' '}
                              </Link>{' '}
                            </Col>{' '}
                            <Col lg={6} as="li" className="mb-2">
                              ...
                              <Link to="#" className="btn btn-country btn-lg btn-block">
                                {' '}
                                <span className="country-selector">
                                  <img alt="" src={imagesData('french')} className="me-3 language" />
                                </span>
                                France{' '}
                              </Link>{' '}
                            </Col>{' '}
                            <Col lg={6} as="li" className="mb-2">
                              ...
                              <Link to="#" className="btn btn-country btn-lg btn-block">
                                {' '}
                                <span className="country-selector">
                                  <img alt="" src={imagesData('mexico')} className="me-3 language" />
                                </span>
                                Mexico{' '}
                              </Link>{' '}
                            </Col>{' '}
                            <Col lg={6} as="li" className="mb-2">
                              ...
                              <Link to="#" className="btn btn-country btn-lg btn-block">
                                {' '}
                                <span className="country-selector">
                                  <img alt="" src={imagesData('singapore')} className="me-3 language" />
                                </span>
                                Singapore{' '}
                              </Link>{' '}
                            </Col>{' '}
                            <Col lg={6} as="li" className="mb-2">
                              ...
                              <Link to="#" className="btn btn-country btn-lg btn-block">
                                {' '}
                                <span className="country-selector">
                                  <img alt="" src={imagesData('poland')} className="me-3 language" />
                                </span>
                                Poland{' '}
                              </Link>{' '}
                            </Col>{' '}
                            <Col lg={6} as="li" className="mb-2">
                              ...
                              <Link to="#" className="btn btn-country btn-lg btn-block">
                                {' '}
                                <span className="country-selector">
                                  <img alt="" src={imagesData('austria')} className="me-3 language" />
                                </span>
                                Austria{' '}
                              </Link>{' '}
                            </Col>{' '}
                            <Col lg={6} as="li" className="mb-2">
                              ...
                              <Link to="#" className="btn btn-country btn-lg btn-block">
                                {' '}
                                <span className="country-selector">
                                  <img alt="" src={imagesData('russia')} className="me-3 language" />
                                </span>
                                Russia{' '}
                              </Link>{' '}
                            </Col>{' '}
                            <Col lg={6} as="li" className="mb-2">
                              ...
                              <Link to="#" className="btn btn-country btn-lg btn-block">
                                {' '}
                                <span className="country-selector">
                                  <img alt="" src={imagesData('germany')} className="me-3 language" />
                                </span>
                                Germany{' '}
                              </Link>{' '}
                            </Col>{' '}
                            <Col lg={6} as="li" className="mb-2">
                              ...
                              <Link to="#" className="btn btn-country btn-lg btn-block">
                                {' '}
                                <span className="country-selector">
                                  <img alt="" src={imagesData('argentina')} className="me-3 language" />
                                </span>
                                Argentina{' '}
                              </Link>{' '}
                            </Col>{' '}
                            <Col lg={6} as="li" className="mb-2">
                              ...
                              <Link to="#" className="btn btn-country btn-lg btn-block">
                                {' '}
                                <span className="country-selector">
                                  <img alt="" src={imagesData('brazil')} className="me-3 language" />
                                </span>
                                Brazil{' '}
                              </Link>{' '}
                            </Col>{' '}
                            <Col lg={6} as="li" className="mb-2">
                              ...
                              <Link to="#" className="btn btn-country btn-lg btn-block">
                                {' '}
                                <span className="country-selector">
                                  <img alt="" src={imagesData('uae')} className="me-3 language" />
                                </span>
                                U.A.E{' '}
                              </Link>{' '}
                            </Col>{' '}
                            <Col lg={6} as="li" className="mb-2">
                              ...
                              <Link to="#" className="btn btn-country btn-lg btn-block">
                                {' '}
                                <span className="country-selector">
                                  <img alt="" src={imagesData('china')} className="me-3 language" />
                                </span>
                                China{' '}
                              </Link>{' '}
                            </Col>{' '}
                            <Col lg={6} as="li" className="mb-2">
                              ...
                              <Link to="#" className="btn btn-country btn-lg btn-block">
                                {' '}
                                <span className="country-selector">
                                  <img alt="" src={imagesData('uk')} className="me-3 language" />
                                </span>
                                U.K{' '}
                              </Link>{' '}
                            </Col>{' '}
                            <Col lg={6} as="li" className="mb-2">
                              ...
                              <Link to="#" className="btn btn-country btn-lg btn-block">
                                {' '}
                                <span className="country-selector">
                                  <img alt="" src={imagesData('malaysia')} className="me-3 language" />
                                </span>
                                Malaysia{' '}
                              </Link>{' '}
                            </Col>{' '}
                            <Col lg={6} as="li" className="mb-2">
                              ...
                              <Link to="#" className="btn btn-country btn-lg btn-block">
                                {' '}
                                <span className="country-selector">
                                  <img alt="" src={imagesData('canada')} className="me-3 language" />
                                </span>
                                Canada{' '}
                              </Link>{' '}
                            </Col>{' '}
                    ...
                    <Dropdown.Menu className="slid1">
                      ...
                      >
                        <div className="main-message-list chat-scroll">
                          ...
                          >
                            <img className="drop-img cover-image" alt="" src={imagesData('female2')} />
                          ...
                          <Dropdown.Item
                            ...
                            className="dropdown-item d-flex border-bottom"
                          >
                            <img className="drop-img cover-image" alt="" src={imagesData('female9')} />
                          ...
                          <Dropdown.Item
                            ...
                            className="dropdown-item d-flex border-bottom"
                          >
                            <img className="drop-img cover-image" alt="" src={imagesData('female5')} />
                  ...
                  <li className="nav-link search-icon d-lg-none d-block">
                    <Form className="navbar-form" role="search" onClick={() => responsivesearch()}>
                      <div className="input-group">
                        <input type="text" className="form-control" placeholder="Search" />
                        <span className="input-group-btn">
                          <Button variant="" type="reset" className="btn btn-default">
                            <i className="fas fa-times"></i>
                          </Button>
                          <Button variant="" className="btn btn-default nav-link resp-btn">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              height="24px"
                              className="header-icon-svgs"
                  ...
                  <Dropdown className=" main-profile-menu nav nav-item nav-link ps-lg-2 m-0">
                    ...
                    <Dropdown.Menu>
                      ...
                      <Dropdown.Item className="dropdown-item" href={`${import.meta.env.BASE_URL}pages/mail/readmail/`}>
            ...
            <div className="d-flex">
              <Link className="demo-icon new nav-link" to="#" onClick={() => swichermainright()}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
