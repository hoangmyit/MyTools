export const LtrtoRtl = () => {
  ...
  document
    ...
    ?.setAttribute('href', '/src/assets/plugins/bootstrap/css/bootstrap.rtl.min.css');
...
export function checkHoriMenu() {
  ...
  const check: any = menuItems.scrollWidth + (0 - menuWidth?.offsetWidth) + menuContainerWidth;
...
export function localStorageBackUp() {
  ...
  if (localStorage.getItem('nowaPrimaryColor') !== null) {
    ...
    html?.setProperty('--primary-bg-color', localStorage.getItem('nowaPrimaryColor'));
    html?.setProperty('--primary-bg-hover', localStorage.getItem('nowaprimaryHoverColor'));
    html?.setProperty('--primary-bg-border', localStorage.getItem('nowaprimaryBorderColor'));
  }
  if (localStorage.getItem('nowadarkPrimaryColor') !== null) {
    ...
    html?.setProperty('--primary-bg-color', localStorage.getItem('nowadarkPrimaryColor'));
    html?.setProperty('--primary-bg-hover', localStorage.getItem('nowadarkPrimaryColor'));
    html?.setProperty('--primary-bg-border', localStorage.getItem('nowadarkPrimaryColor'));
  }
  if (localStorage.getItem('nowatransparentPrimaryColor') !== null) {
    ...
    body?.classList.remove('light-theme');
    body?.classList.remove('dark-theme');
    html?.setProperty('--primary-bg-color', localStorage.getItem('nowatransparentPrimaryColor'));
  }
  if (localStorage.getItem('nowatransparentBgColor') !== null) {
    ...
    body?.classList.remove('light-theme');
    body?.classList.remove('dark-theme');
    html?.setProperty('--transparent-body', localStorage.getItem('nowatransparentBgColor'));
  }
  if (
    ...
    body?.classList.remove('dark-theme');
    const img: any = localStorage.getItem('nowaBgImage');
    html?.setProperty('--primary-bg-color', localStorage.getItem('nowatransparent-bgImgPrimaryColor'));
